...
const INTERNSHIPS = [
  {
    ...
    certificate: "/certificates/internships/codealpha-data-science.jpg",
  },
  {
    role: "Data Science Intern",
    company: "Codec Technologies Pvt. Ltd.",
    duration: "06 June 2026 – 06 July 2026",
    certificate: "/certificates/internships/codec-data-science.jpg",
  },
  {
    role: "Data Science & Machine Learning Intern",
    company: "Soft Nexis Technology",
    duration: "01 June 2026 – 08 July 2026",
    certificate: "/certificates/internships/soft-nexis-data-science-ml.jpg",
  },
  {
    role: "Java Programming Intern",
    company: "CodSoft",
    duration: "Completed",
    certificate: "/certificates/internships/codsoft-java.jpg",
  },
  {
    role: "Front-End Developer Intern",
    company: "StaxTech",
    duration: "Completed",
    certificate: "/certificates/internships/staxtech-frontend.jpg",
  },
  {
    role: "Python Developer Intern",
    company: "The Skybrisk",
    duration: "Completed",
    certificate: "/certificates/internships/skybrisk-python-developer-offer.jpg",
...
const CERTIFICATIONS = [
  {
    ...
    certificate: "/certificates/learning/python-programming-microsoft.jpg",
  },
  {
    title: "Machine Learning with Python",
    organization: "IBM / Cognitive Class",
    certificate: "/certificates/learning/machine-learning-ibm.jpg",
  },
  {
    title: "Cybersecurity",
    organization: "Tech Mahindra Foundation / Skill India Digital Hub",
    certificate: "/certificates/learning/cybersecurity-tech-mahindra.jpg",
  },
  {
    title: "5-Day AI Agents Intensive Course",
    organization: "Google / Kaggle",
    certificate: "/certificates/learning/ai-agents-google-kaggle.jpg",
  },
  {
    title: "Data Structures & Algorithms Course for Beginners",
    organization: "ScholarHat",
    certificate: "/certificates/learning/dsa-scholarhat.jpg",
  },
  {
    title: "Complete 2025 Python Bootcamp",
    organization: "CodeWithHarry",
    certificate: "/certificates/learning/python-bootcamp-codewithharry.jpg",
  },
  {
    title: "The Ultimate Job Ready Data Science Course",
    organization: "CodeWithHarry",
    certificate: "/certificates/learning/data-science-codewithharry.jpg",
  },
  {
    title: "Career Essentials in Generative AI",
    organization: "Microsoft + LinkedIn Learning",
    certificate: "/certificates/learning/generative-ai-microsoft-linkedin.jpg",
  },
];
...
const ACHIEVEMENTS = [
  {
    ...
    certificate: "/certificates/achievements/n8n-hackathon-letsupgrade.jpg",
  },
  {
    ...
    certificate: "/certificates/achievements/internship-common-aptitude-test.jpg",
  },
  {
    ...
    certificate: "/certificates/achievements/unstop-48th-rank.jpg",
  },
  {
    ...
    certificate: "/certificates/achievements/linux-foundation-secure-ai-ml.jpg",
  },
  {
    ...
    <div className={darkMode ? "app dark" : "app light"}>
      ...
      <nav className="navbar">
        ...
        <div className="nav-links">
          ...
          <button onClick={() => scrollToSection("ai")}>AI</button>
      ...
      <section id="home" className="section hero">
        <div className="hero-content">
          <span className="badge">🚀 Fresher • AI/ML & Data Science</span>

          <h1>
            Hi, I'm <span className="gradient-text">Faizan Khan</span>
          </h1>

          <h2>B.Tech IT Student | AI/ML & Data Science Enthusiast</h2>

          <p className="hero-description">
            I build practical solutions using Python, Machine Learning, Data
            Science, Deep Learning, Computer Vision and Web Development.
          </p>
        ...
        <div className="hero-visual">
          ...
          <div className="floating-card floating-two">📊 Data Science</div>
      ...
      {resumeOpen && (
        <div className="resume-modal">
          ...
          <div className="resume-viewer">
            <Document
              file="/resume/Faizan_Khan_Resume.pdf"
              ...
              {Array.from(new Array(numPages || 0), (_, index) => (
                <div className="resume-page" key={`page_${index + 1}`}>
                  <Page
                    pageNumber={index + 1}
                    width={Math.min(
                      window.innerWidth > 900 ? 850 : window.innerWidth - 30,
                      850
                    )}
      ...
      <section id="about" className="section">
        <div className="section-heading">
          <span>ABOUT ME</span>
          <h2>Building with AI & Technology</h2>
        </div>

        <div className="about-grid">
          <div className="about-text">
            <p>
              I'm <strong>Faizan Khan</strong>, a B.Tech Information
              Technology student at Dr. Ram Manohar Lohia Avadh University.
            </p>

            <p>
              I'm currently pursuing my 5th semester and developing practical
              projects in Artificial Intelligence, Machine Learning, Data
              Science, Deep Learning, Computer Vision and Web Development.
            </p>

            <p>
              My career objective is to build strong technical and
              problem-solving skills and begin my professional career in AI,
              Data Science or Software Development.
            </p>
          </div>

          <div className="about-card">
            <InfoRow label="Education" value="B.Tech IT" />
            <InfoRow label="University" value="RML Avadh University" />
            <InfoRow label="Semester" value="5th Semester" />
            <InfoRow label="CGPA" value="8.1" />
            <InfoRow label="Status" value="Fresher" />
            <InfoRow label="Graduation" value="2028" />
          </div>
        </div>
      </section>
      ...
      <section id="experience" className="section">
        <div className="section-heading">
          ...
          <p>Completed internships and practical industry experience.</p>
        </div>
          ...
          {INTERNSHIPS.map((internship, index) => (
            <div className="experience-card" key={index}>
              ...
              <div>
                ...
                >
                  {internship.documentLabel || "View Certificate"} ↗
                </a>
              </div>
            </div>
          ))}
      ...
      <section id="projects" className="section">
        <div className="section-heading">
          ...
          <p>Explore my projects and source code on GitHub.</p>
        </div>
      ...
      <section id="certifications" className="section">
        <div className="section-heading">
          ...
          <p>Courses and certifications completed during my learning journey.</p>
        </div>
      ...
      <section id="achievements" className="section">
        <div className="section-heading">
          ...
          <p>Competitions, participation and additional learning achievements.</p>
        </div>
      ...
      <section id="ai" className="section ai-section">
        <div className="section-heading">
          ...
          <h2>Meet Faizan AI 🤖</h2>
          <p>
            Ask about Faizan's projects, skills, education, internships,
      ...
      <section id="contact" className="section contact">
        <div className="section-heading">
          <span>CONTACT</span>
          <h2>Let's Connect</h2>
          <p>Open to opportunities, collaboration and learning.</p>
        </div>
      ...
      <footer>
        ...
        <p>© 2026 Faizan Khan • Built with React, FastAPI & AI</p>
      </footer>
    </div>
  );
}
